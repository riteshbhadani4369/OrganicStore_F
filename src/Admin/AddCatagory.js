...
const AddCatagory = () => {
    ...
    const btnHandlar = () => {
        axios.post("http://localhost:5000/createCatagory", {
            catagoryname: name
        })
    ...
    const btndeletehandle = (id) => {
        axios.get(`http://localhost:5000/deleteCatagory/${id}`)
            .then(function (response) {
                // console.log(response);
                setCatagory(response.data)
                navigate("/dashboard")
                    ...
                    <div className="main-panel">
                        <div className="content-wrapper">
                            <div className="page-header">
                                <h3 className="page-title"> Add categoy </h3>
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb">
                                        <li className="breadcrumb-item"><Link to="/dashboard">Dashboard</Link></li>
                                        <li className="breadcrumb-item active" aria-current="page">Add categoy</li>
                                    </ol>
                                </nav>
                            </div>
                            <div className="row">
                                <div className="col-md-6 grid-margin stretch-card">
                                    <div className="card">
                                        <div className="card-body">
                                            <h4 className="card-title">Add categoy</h4>
                                            <p className="card-description"> categoy form layout </p>
                                                ...
                                                catagory.map((val, i) => {
                                                    return (
                                                        ...
                                                        <tbody key={i}>
                                                            <tr class="table-info">
                                                                <td> {val._id} </td>
                                                                <td> {val.catagoryname} </td>
                                                                <td> <Link to={`/editCatagory/${val._id}`}><button style={{ padding: "10px 15px", color: "#fff", backgroundColor: "blue", border: "none" }}>Edit</button> </Link></td>
