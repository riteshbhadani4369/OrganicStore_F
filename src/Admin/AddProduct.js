    ...
    const btnHandlar = (e) => {
        ...
        axios.post("http://localhost:5000/createproduct",
            ...
            .then(function (response) {
                ...
                // setStock("")
                // setCatagory("")
                nagigate("/dashboard/viewproduct")
            })
                                        ...
                                        <div className="card-body">
                                            ...
                                            <form className="forms-sample">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input type="file" multiple className="form-control" id="exampleInputEmail1" placeholder="Image" name="productImage" onChange={fileOnChange} />
                                                </div>
                                                <div className="form-group">
