            ...
            <Fragment>
                {cartItems.length === 0 ? (
                    <div className="emptyCart">
                        ...
                        <Typography className="my-4">No Product in Your Cart</Typography>
                        {/* <h2  style={{ fontFamily: "'Poppins', sans-serif" }}>No Product in Your Cart</h2> */}
                        <Link to="/allproduct">View Products</Link>
                    </div>
                ) : (
                    <Fragment>
